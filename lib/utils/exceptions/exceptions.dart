...
class TExceptions implements Exception {
  ...
  factory TExceptions.fromCode(String code) {
    switch (code) {
      ...
      case 'user-not-found':
        return const TExceptions('Invalid loginController details. User not found.');
      case 'wrong-password':
        return const TExceptions('Incorrect password. Please check your password and try again.');
      case 'INVALID_LOGIN_CREDENTIALS':
        return const TExceptions('Invalid loginController credentials. Please double-check your information.');
